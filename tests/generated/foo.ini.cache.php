...
namespace WatchFiles\Generated\Label_020e24af40d0d5167ba2c1aad42c5b14a2463a0b;

function get_list() {
    return array(
        'files' => array(
            __DIR__ . "/../features/config/foo.ini",
...
function get_watched_files() {
  ...
  'files' => 
  array (
    0 => '/home/crodas/projects/newest/ServiceProvider/tests/features/config/foo.ini',
...
function has_changed()
{
    ...
    if (!is_file(__DIR__ . "/../features/config/foo.ini") || filemtime(__DIR__ . "/../features/config/foo.ini") > 1382830133) {
        return __DIR__ . "/../features/config/foo.ini";
    }
